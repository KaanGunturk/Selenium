...
public class C03_Locators {
    ...
    public static void main(String[] args) {
        ...
        WebElement sigbInButonu = driver.findElement(By.name("commit"));
        ...
        System.out.println(actualKullaniciAdiElementi.getText());// WebElemnt bir String değil bu yuzden getText() methodunu kullandik. -->testtechproed@gmail.com
        ...
        for (WebElement each : linklerListesi) { //Listemiz WebElementlerden olustugu icin direk yazdiramayiz referanslari yazdirir
